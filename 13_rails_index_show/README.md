...
- Use ActionView helpers like `link_to` to help write HTML
- Use Route Helpers


## App: Snacks on a Plane
  - snacks -< rating >- users
  - snack: name (string), brand (string), flavor_profile (string), rating (integer)


## Outline
- [✅] Create our model using `rails g model` `rails g controller` 
