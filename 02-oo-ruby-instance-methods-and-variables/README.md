...
* Every dog needs some info:
    ...
    * name 
    ...
    How do we assign those values? Let's add some attributes to the manual:
...
* How do we access these values?
    ...
    * Confused what method to write?
        * if you want to have access to an attribute but don't want to change its value later -> getter/reader method
        * if you want to have an opportunity to change the attribute's value -> setter/writer method
        * if you want to have both access and an ability to change its value -> both
